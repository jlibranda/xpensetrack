    ...
    <div className="flex h-screen bg-gray-50 font-sans">
      <aside className="w-52 bg-white border-r border-gray-100 flex flex-col shrink-0">
        ...
        <div className="p-3 border-t border-gray-100">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center text-brand-600 text-xs font-medium shrink-0">
              {initials}
            </div>
            ...
            <button onClick={() => { logout(); navigate('/login'); }}
              className="text-xs text-gray-400 hover:text-gray-600 px-1">Out</button>
          </div>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-14 bg-white border-b border-gray-100 flex items-center justify-end px-6 gap-3 shrink-0">
          ...
          <button onClick={() => navigate('/expenses/new')}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-brand-400 text-white text-sm font-medium hover:bg-brand-600 transition-colors">
            + New Expense
          </button>
        </header>
